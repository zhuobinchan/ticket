...
<SCRIPT type="text/javascript">
    ...
    function queryData(e,queryForm){
    	...
    	$.ajax({
    		url:"<%=path%>/public/stat/queryMemberCommission.htmls",
    		type:"POST",
    		dataType:"json",
    		async:false,
    		data:param,
    		success:function(ret){
    			if(ret==''){
    				table.append($("<tr><td colspan='14'>没有数据！</td></tr>"));
    				return;
    			}
    			var tr = null;
    			...
    			for(var i=0;i<ret.length;i++){
    				...
    				amount += parseInt(fields[9]);
    				commision += parseInt(fields[11]);
    				totalNum += parseInt(fields[12]);
    ...
    function CreateOneFormPage(){
    	...
    	LODOP.ADD_PRINT_HTM(40,"11mm", div.width(), 39,
    			"<div style='width:"+div.width()+";text-align:center;font-size:13pt'>会员卡提成明细表</div>");
    	//LODOP.ADD_PRINT_HTM(40,"11mm", div.width(), 39,
