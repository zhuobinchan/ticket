...
<SCRIPT type="text/javascript">
    ...
    function queryData(e,queryForm){
    	...
    	$.ajax({
    		url:"<%=path%>/public/stat/queryMemberCommissionStat.htmls",
    		type:"POST",
    		dataType:"json",
    		async:false,
    		data:param,
    ...
    function CreateOneFormPage(){
    	...
    	LODOP.ADD_PRINT_HTM(40,"11mm", div.width(), 39,
    			"<div style='width:"+div.width()+";text-align:center;font-size:13pt'>会员卡提成统计表</div>");
    	//LODOP.ADD_PRINT_HTM(40,"11mm", div.width(), 39,
...
<th width="30"></th>
<th width="100">营销号</th>
<th width="100">营销员</th><th width="140">服务部门</th>
