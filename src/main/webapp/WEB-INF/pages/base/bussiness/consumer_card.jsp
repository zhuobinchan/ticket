...
<script type="text/javascript" src="<%=path%>/static/js/base/business/consumer_card.js"></script>
</head>
...
<body>
			...
			<table width="100%">
				<tr>
					<td align="center"><table align="center">
							...
							<tr>
								<td>绑定默认会员<span style="color: red;">*</span></td>
								<td><input type="radio" name="defaultMember" checked="checked" value="1" />虚拟会员资料 <input type="radio"
									name="defaultMember" value="" />不绑定</td>
							</tr>
							<tr>
								<td>充值金额</td>
								<td><input id="money" name="money" type="number" value="0" min="0" max="1000000" style="width: 100%;"></input></td>
							</tr>
							<tr>
			...
			<table width="100%">
				<tr>
					<td align="center"><table align="center">
							...
							<tr>
								<td>充值方式<span style="color: red;">*</span></td>
								<td><select id="payTypeRe" name="payTypeRe" style="width: 100%;" class="required"></select></td>
							</tr>
						</table></td>
				</tr>
			</table>
	...
	<div style="display: none;">
		<form id="fmMergeMemberCard" class="validate">
			<table width="100%">
				<tr>
					<td align="center"><table align="center">
							<tr>
								<td>主卡卡号<span style="color: red;">*</span></td>
								<td><input id="receiveId" name="receiveId" type="text" class="required" minlength="8" maxlength="18"
									style="width: 100%;"></input></td>
							</tr>
							<tr>
								<td>次卡卡号<span style="color: red;">*</span></td>
								<td><input id="sendId" name="sendId" type="text" class="required" minlength="8" maxlength="18"
									style="width: 100%;"></input></td>
							</tr>
							<tr>
								<td>合并金额<span style="color: red;">*</span></td>
								<td><input id="mergeMoney" name="mergeMoney" min="0" max="10000" type="number" class="required"
									style="width: 100%"></input></td>
							</tr>
						</table></td>
				</tr>
