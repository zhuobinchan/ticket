...
<script type="text/javascript" src="<%=path%>/static/js/base/business/member_card.js"></script>
</head>
				...
				<tr>
					<td align="center"><table align="center">
							...
							<tr>
								...
								<td><input uitype="autocomplete" type="text" name="cardSalesmanId_txt" id="cardSalesmanId_txt"
									class="ui-autocomplete-input required" autocomplete="off" style="width: 100%"> <input
										uitype="autocomplete" type="hidden" name="cardSalesmanId" id="cardSalesmanId"></td>
							</tr>
						</table></td>
				</tr>
			</table>
		...
		<form id="fmMemberCardChangeSalesman" class="validate">
			<table width="100%" height="100%">
				<tr>
					<td align="center"><table align="center">
							<tr>
								<td>新营销员<span style="color: red;">*</span></td>
								<td><input uitype="autocomplete" type="text" name="newSalesmanId_txt" id="newSalesmanId_txt"
									class="ui-autocomplete-input required" autocomplete="off" style="width: 100%"> <input
										uitype="autocomplete" type="hidden" name="newSalesmanId" id="newSalesmanId"></td>
							</tr>
						</table></td>
				</tr>
			</table>
