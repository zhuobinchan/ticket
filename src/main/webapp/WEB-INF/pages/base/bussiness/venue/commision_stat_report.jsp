...
<script type="text/javascript" src="<%=path%>/static/js/base/business/venue/commision_stat_report.js"></script>
</head>
...
<body>
	...
	<div id="list" class="rbox1">
		<div class="rcon2">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mtable" id="tbResult">
			</table>
		</div>
	</div>
