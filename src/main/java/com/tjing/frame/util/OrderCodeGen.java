...
public class OrderCodeGen {
    ...
    public static void main(String[] args) throws InterruptedException {
        SerialNumber serial = new FileEveryDaySerialNumber(6, "EveryDaySerialNumber1.dat");
       // while(true) {
    ...
    public static String genCode(String prefix,int length){
    	SerialNumber serial = new FileEveryDaySerialNumber(length, "EveryDaySerialNumber1.dat");
...
abstract class EveryDaySerialNumber extends SerialNumber {
    ...
    protected String process() {
        ...
        return todayDt.toString("yyMMdd") + format(n)+todayDt.toString("SSS");
    }
