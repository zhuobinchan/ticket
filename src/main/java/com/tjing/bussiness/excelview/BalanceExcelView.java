...
@Component
public class BalanceExcelView extends ExcelViewModel{
	@Autowired
	...
	protected void buildExcelDocument(Map<String, Object> model,HSSFWorkbook hw, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        ra.setCellValue(hs, hr, 16, "", infStyle);
        ra.setCellValue(hs, hr, 17, "", infStyle);
        ra.setCellValue(hs, hr, 18, "", infStyle);
        ra.setCellValue(hs, hr, 19, "", infStyle);
        ra.setCellValue(hs, hr, 20, "", infStyle);
        ...
        String[] columnLetters = {"C","D","E","F","G","H","I","J","K","L","M","N","O","P","Q","R","S","T","U"};
